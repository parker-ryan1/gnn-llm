...
Analysis: GNN results analyzed to identify product needs
Search: Web scraping of Amazon/eBay for relevant products
Evaluation: LLM evaluates each product for relevance and quality
Filtering: Budget and confidence-based filtering
Recommendation: Ranked list of purchase recommendations
Ordering: Optional automated purchasing (DEMO MODE ONLY)
📊 Sample Output
